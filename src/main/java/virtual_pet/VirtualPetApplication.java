...
//TODO Add something to interact with the pet if it needs something
    ...
    public ArrayList<VirtualPet> petShelter() {
        ...
        Random rand = new Random();
        Scanner input = new Scanner(System.in);
        ArrayList <VirtualPet> adoptList = new ArrayList<>();
        System.out.println("Before starting the game. How many animals do you want in the virtual pet shelter? (Enter a number): ");
        int numberOfAnimals = input.nextInt();
        input.nextLine();
